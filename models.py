...
class SessionTypes(messages.Message):
    """SessionTypes -- Types of Session outbound form message"""
    types = messages.StringField(1, repeated=True)

class SessionWishList(ndb.Model):
    """SessionWishList -- Session WishList object"""
...
class SessionWishListForm(messages.Message):
    """SessionWishListForm -- Session WishList outbound form message"""
...
class SessionWishListForms(messages.Message):
    """SessionWishListForms -- multiple Session WishList outbound form message"""
